...
class _PHQ9ScreenState extends State<PHQ9Screen> {
  ...
  final List<int?> answers = List.filled(9, null);
  ...
  Future<void> _submitAssessment() async {
    ...
    await context.read<AssessmentProvider>().submitPHQ9(
      userId,
      answers.cast<int>(),
    );
  ...
  String _getSeverityMessage(int score) {
    if (score <= 4) return 'Minimal - Tidak ada atau gejala depresi minimal';
    if (score <= 9) return 'Ringan - Gejala depresi ringan';
    if (score <= 14) return 'Sedang - Gejala depresi sedang';
    if (score <= 19) return 'Sedang-Berat - Gejala depresi sedang hingga berat';
    return 'Berat - Gejala depresi berat';
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Kuesioner PHQ-9'),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  Text(
                    AssessmentProvider.phq9Questions[index],
                    style: const TextStyle(
                      fontSize: 18,
                      fontWeight: FontWeight.bold,
                    ),
                ...
                return ElevatedButton(
                  ...
                  child: provider.isLoading
                    ...
                    child: CircularProgressIndicator(
                      ...
                      : Text(
                    currentPage < 8 ? 'Selanjutnya' : 'Selesai',
                    style: const TextStyle(
                      fontSize: 16,
                      fontWeight: FontWeight.bold,
                    ),
